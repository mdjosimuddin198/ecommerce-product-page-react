...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { label: "Women", path: "/women", className: "hover:text-black" },
    { label: "About", path: "/about", className: "hover:text-black" },
    { label: "Contact", path: "/contact", className: "hover:text-black" },
  ];
